			...
			<div class="row">
				...
				<div class="col-5 btn-group">
				  ...
				  <div class="dropdown-menu">
				    <a class="dropdown-item" href="?confirmacao=confirmado&id_evento=<?=$_GET['ver']?>">Participar</a>
				    <a class="dropdown-item" href="?confirmacao=interessado&id_evento=<?=$_GET['ver']?>">Interessado</a>
				    <a class="dropdown-item" href="?confirmacao=nao&id_evento=<?=$_GET['ver']?>">Não participar</a>
				  </div>
				</div>

				<div class="col-7 text-right">
					<a href="evento.php?edt=<?=$id?>"><button type="button" class="btn btn-primary">Editar evento</button></a>&nbsp;
